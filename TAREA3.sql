...
BEGIN
       FOR registro2 in EMPL LOOP
            ...
            UPDATE EMPLOYEES SET SALARY = (registro2.salary*0.02)+registro2.salary WHERE CURRENT OF EMPL;
               /* DBMS_OUTPUT.PUT_LINE((registro2.salary*0.02)+registro2.salary);*/
            ELSIF(registro2.salary < 8000) THEN
            UPDATE EMPLOYEES SET SALARY = (registro2.salary*0.03)+registro2.salary WHERE CURRENT OF EMPL;
               /* DBMS_OUTPUT.PUT_LINE((registro2.salary*0.03)+registro2.salary);*/
            END IF;
       END LOOP;
END;
